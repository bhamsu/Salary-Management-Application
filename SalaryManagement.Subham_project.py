...
Unfortunately I Subham Das from KV OF DUM DUM (batch 2019-20) made this application with my little knowledge of Python
and Computer. '''
...
""" Module mysql.connector is used for the connection of Python program with mysql database. So that I can store 
all the data related to the application can be stored in the database in a secured manner. """

""" Package matplotlib and its module is used for creating the graphs and emerge them with the tkinter window using 
Figure, Image and Canvas function. """

""" PIL is the Python Imaging Library which provides the python interpreter with image editing capabilities. """

""" Module numpy is used for storing data in a uniform way so that it become easy extract and use them with their 
index values. """

""" Module base64 is used here to encode and decode the data stored in the database, so that any outsider cannot 
access or understand the password stored in the mysql database.. """
...
class startpage :
    ...
    def __init__(self, win) :
        ...
        try :
            ...
            self.db = sql.connect(host = "localhost", user = "root", passwd = "18180612", database = "salarymanagement")
            self.cur = self.db.cursor()
        ...
        self.lab1 = Label(self.home_frame, text = "Name :", bg = "#17616E", fg = "white", font = "agencyfb")
        self.lab2 = Label(self.home_frame, text = "Age  :", bg = "#17616E", fg = "white", font = "agencyfb")
        ...
        def options() :
            ...
            self.lab3 = Label(self.home_frame, text = "Gender :", bg = "#17616E", fg = "white", font = "agencyfb")
            ...
            self.optnbtn.configure(bd = 0, height = 1, width = 12, font = "Arial", bg = "#FDFEFE", fg = "#F02D94",
